/* ============================================================
   NXR here — channel data (bilingual: id + en)
...
id: {
  ...
  termTry: 'coba',
  termPsst: 'psst: coba <code>neofetch</code>, <code>sudo hire-me</code>, atau <code>projects</code>',
  ui: {
    actAnasta: 'jagain AnastaChronicle',
    actArc: 'idle di Arc testnet',
    offlineMsg: 'enggak ada. gw selalu online 😌',
    popNote: 'bali based · di github sejak 2013 · ship > talk'
  },
  ...
  channels: {
        ...
        },
        {
          ...
          projects: [
            { icon: '🔮', color: '#a855f7', name: 'ritual-chain-workshop', stars: 19,
              ...
              lang: 'TypeScript', lc: '#3178c6', chips: ['ritual', 'on-chain AI'], url: GH + '/ritual-chain-workshop' },
    ...
    'terminal': {
      ...
      messages: [
        ...
        { author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR, time: '12.01', terminal: true }
      ]
    },
  ...
  termCmds: {
    ...
    whoami: () => [['out', 'guest@nxr-labs — tapi kalo mau jadi collaborator, tinggal bilang.']],
    ls: () => [
    ...
    uptime: () => {
      ...
      return [['out', `up ${yrs} tahun — akun github dibuat maret 2013, dan belum pernah pensiun.`]];
    },
    neofetch: () => [
      ['ok', '        ⬡⬡⬡        guest@nxr-labs'],
      ['out', '      ⬡⬡⬡⬡⬡⬡      ───────────────'],
    ...
    'sudo rm -rf /': () => [['err', 'nice try. 🛡️ server ini dijaga 24/7.']]
  }
},
...
en: {
  todayAt: 'today at ',
  termTry: 'try',
  termPsst: 'psst: try <code>neofetch</code>, <code>sudo hire-me</code>, or <code>projects</code>',
  ui: {
    actAnasta: 'guarding AnastaChronicle',
    actArc: 'idling on Arc testnet',
    offlineMsg: 'nobody. I\'m always online 😌',
    popNote: 'bali based · on github since 2013 · ship > talk'
  },
  ...
  channels: {
      ...
      messages: [
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', avatar: null, icon: '🤖',
          time: '27/07/2026 09.00',
          html: `<strong>Welcome to NXR LABS, <span class="mention">@everyone</span> 👋</strong><br>
                 Personal portfolio server of <strong>nxrskyaa</strong> — web3 builder, game dev, and AI agent tinkerer from Bali 🌴<br>
                 Pick a channel on the left, or type anything below. There's a bot on duty here.`,
          reacts: [{ e: '👋', n: 12 }, { e: '🔥', n: 8 }, { e: '🌴', n: 5 }]
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR,
          time: '27/07/2026 09.02',
          html: `yo. I'm <strong>NXR</strong> — been on GitHub since <code>2013</code>, but only started building seriously in the last few years. right now I'm focused on three things: <strong>web3</strong> (Ritual, Monad, Arc), <strong>game dev</strong>, and <strong>AI agents</strong> that run on-chain.`
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR, compact: true,
          time: '09.03',
          html: `my principle is simple: <strong>ship &gt; talk</strong>. better to release something imperfect but real than a beautiful roadmap that never ships.`
        },
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '09.04',
          embed: {
            ...
            title: 'nxrskyaa — NXR',
            desc: 'Bali, Indonesia · building at the intersection of web3 × games × AI',
            fields: [
              { l: 'location', v: 'Bali 🌴' },
              { l: 'on github since', v: 'March 2013' },
              { l: 'public repos', v: '44+' },
              { l: 'status', v: '🟢 open to collab' }
            ]
          }
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR,
          time: '09.06',
          html: `if you want to see everything I've made, head straight to <a href="${GH}" target="_blank" rel="noopener">github.com/nxrskyaa</a> — or go to <span class="mention">#projects</span> for the highlights.`
        }
      ]
    },

    'projects': {
      topic: 'what I build & ship',
      messages: [
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '10.00',
          html: `Highlights from <a href="${GH}" target="_blank" rel="noopener">44+ public repos</a>. What's here is what I'm most proud of — check GitHub for the rest.`
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR,
          time: '10.01',
          projects: [
            { icon: '🔮', color: '#a855f7', name: 'ritual-chain-workshop', stars: 19,
              desc: 'On-chain AI bounty judge on Ritual. Built & deployed the contract + TEE-verified inference — my most starred repo.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['ritual', 'on-chain AI'], url: GH + '/ritual-chain-workshop' },
            { icon: '🎮', color: '#23a55a', name: 'AnastaChronicle', stars: null,
              desc: 'Browser game with 100% code-generated art. Live at anasta-chronicle.vercel.app — play it now.',
              lang: 'JavaScript', lc: '#f1e05a', chips: ['game', 'live'], url: 'https://anasta-chronicle.vercel.app' },
            { icon: '⚡', color: '#f0b232', name: 'CONSTUAL', stars: 7,
              desc: 'TypeScript project that gained organic traction from the community.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['typescript'], url: GH + '/CONSTUAL' },
            { icon: '🎫', color: '#00a8fc', name: 'UniskyPass', stars: null,
              desc: 'Passport / identity on Monad — built for the Monad Spark Hackathon.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['monad', 'hackathon'], url: GH + '/UniskyPass' },
            { icon: '📡', color: '#f23f43', name: 'ritual-agent-feeds', stars: null,
              desc: 'Ritual Agent Terminal — on-chain message feed on Ritual Testnet.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['ritual', 'agent'], url: GH + '/ritual-agent-feeds' },
            { icon: '🕹️', color: '#eb459e', name: 'Arcynite', stars: null,
              desc: 'Colorful gamified onboarding for Arc Testnet. An MVP game that turns testnet into a playground.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['arc', 'game'], url: GH + '/arcynite' },
            { icon: '🤖', color: '#5865f2', name: 'RialoTempleAgent', stars: null,
              desc: 'AI agent experiment — one of several agents I\'ve been tinkering with.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['ai', 'agent'], url: GH + '/RialoTempleAgent' },
            { icon: '🧪', color: '#949ba4', name: 'NxrLabsFableTest', stars: null,
              desc: 'Premium SaaS landing — Next.js 14, TypeScript, Tailwind, Framer Motion.',
              lang: 'TypeScript', lc: '#3178c6', chips: ['next.js', 'landing'], url: GH + '/NxrLabsFableTest' },
            { icon: '🌌', color: '#00a8fc', name: 'Semesta', stars: null,
              desc: 'Another JavaScript experiment currently in the works.',
              lang: 'JavaScript', lc: '#f1e05a', chips: ['wip'], url: GH + '/Semesta' }
          ]
        },
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '10.05',
          html: `💡 the pattern is clear: I like building things that are <strong>on-chain</strong> but feel like <strong>toys</strong>. gamified onboarding, games, agents — everything should be fun to use.`,
          reacts: [{ e: '🎯', n: 6 }]
        }
      ]
    },
      ...
      messages: [
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '11.00',
          html: `The stack I use almost every day. numbers = how often I use it, not how good I am (being honest).`
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR,
          time: '11.01',
        ...
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR, compact: true,
          time: '11.02',
          html: `plus: <code>git</code> <code>bash</code> <code>python</code> for scripting, <code>Vercel</code> for deploys, and the most important skill of all — <strong>reading the docs until I find it</strong>.`
        },
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '11.03',
          embed: {
            ...
            title: 'Ritual · Monad · Arc',
            desc: 'Three ecosystems I\'m deep in right now — on-chain AI inference on Ritual, high-throughput EVM on Monad, and Arc for agent infra.',
            fields: [
              { l: 'ritual', v: '🔮 on-chain AI' },
              { l: 'monad', v: '⚡ parallel EVM' },
              { l: 'arc', v: '🌐 agent infra' }
    ...
    'terminal': {
      topic: 'talk to the shell. try typing `help`',
      messages: [
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '12.00',
          html: `This channel is different. Below is a real terminal (well, fake — but interactive). Type <code>help</code> to see all commands.`
        },
        { author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR, time: '12.01', terminal: true }
      ]
    },
      ...
      messages: [
        {
          author: 'NXR Bot', badge: 'BOT', color: '#23a55a', icon: '🤖',
          time: '13.00',
          html: `Want to collab, build together, or just ask around? All doors below are open. Fastest response is usually on <strong>Telegram</strong>.`
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR,
          time: '13.01',
        ...
        },
        {
          author: 'nxrskyaa', color: '#f2f3f5', avatar: AVATAR, compact: true,
          time: '13.02',
          html: `if you find a bug on this website — let me know. that counts as a contribution too 😄`,
          reacts: [{ e: '😂', n: 9 }, { e: '🤝', n: 4 }]
        }
      ]
    }
  ...
  botReplies: [
    'noted. I\'ll pass it on to NXR 👍',
    'lol, so true.',
    'hmm, interesting. ask directly at <span class="mention">@nxrskyaa</span> on telegram.',
    'I\'m just the server\'s guard bot, but I agree with you.',
    'message received 📬 — NXR usually replies when he\'s not deploying.',
    'nice. btw, have you checked <span class="mention">#projects</span> yet?',
    'if you want to collab, just DM. NXR is a fast responder.',
    '🔥🔥🔥',
    'error 418: I\'m a teapot. I mean... your message has been noted.',
    'agreed. ship &gt; talk.'
  ],

  botEaster: {
    'hello': 'hello to you too! 👋 rare for someone to greet first.',
    'halo': 'hello! 👋 welcome in.',
    'hi': 'hey! welcome to NXR LABS 🏝️',
    'hey': 'hey! welcome to NXR LABS 🏝️',
    'who': 'I\'m NXR Bot — this server\'s guard. my boss is <strong>nxrskyaa</strong>, a web3 builder from Bali.',
    'who are you': 'I\'m NXR Bot — this server\'s guard. my boss is <strong>nxrskyaa</strong>, a web3 builder from Bali.',
    'game': 'favorite game I\'ve guarded: <strong>AnastaChronicle</strong> 🎮 — 100% code-gen art, live on Vercel.',
    'ritual': 'Ritual is an L1 for on-chain AI inference 🔮 my boss deployed a bounty judge there — check <span class="mention">#projects</span>.',
    'monad': 'Monad ⚡ a seriously fast parallel EVM. my boss built <strong>UniskyPass</strong> there during a hackathon.',
    'bali': 'Bali 🌴 the official basecamp of NXR LABS. coding while listening to the waves, or so they say.',
    'work': 'open to collab! 🤝 just DM telegram <span class="mention">@nxrskyaa</span>.',
    'hire': 'open to collab! 🤝 just DM telegram <span class="mention">@nxrskyaa</span>.',
    'collab': 'open to collab! 🤝 just DM telegram <span class="mention">@nxrskyaa</span>.',
    'contact': 'all doors are in <span class="mention">#contact</span> — github, X, telegram, email.',
    'email': 'my boss\'s email: <code>Nxrskyaa@gmail.com</code> 📮',
    'thank you': 'you\'re welcome! 🙌',
    'thanks': 'anytime! 🤙',
    'lol': 'lol 😂',
    'lmao': 'lmao 😂',
    'p': 'p to you too. if you want a full conversation, not just "p" 😄'
  },

  termCmds: {
    help: () => [
      ['dim', 'available commands:'],
      ['out', '  whoami        — who you are here'],
      ['out', '  ls            — peek inside my "home"'],
      ['out', '  skills        — my stack'],
      ['out', '  projects      — repo highlights'],
      ['out', '  contact       — how to reach me'],
      ['out', '  socials       — all the links'],
      ['out', '  uptime        — how long I\'ve been building'],
      ['out', '  neofetch      — a little flex'],
      ['out', '  sudo hire-me  — just try it 😏'],
      ['out', '  clear         — clear the screen']
    ],
    whoami: () => [['out', 'guest@nxr-labs — but if you want to be a collaborator, just say the word.']],
    ls: () => [
      ['out', 'anasta-chronicle/   ritual-workshop/   uniskypass/'],
      ['out', 'constual/           arcynite/          agent-feeds/'],
      ['out', 'semesta/            rialo-agent/       bali-vibes.mp3']
    ...
    projects: () => [
      ['out', '★ 19  ritual-chain-workshop  — on-chain AI bounty judge'],
      ['out', '★  7  CONSTUAL               — typescript project'],
      ['out', '      AnastaChronicle        — browser game, live on vercel'],
      ['out', '      UniskyPass             — Monad Spark hackathon'],
      ['dim', '...and 40+ more repos at github.com/nxrskyaa']
    ],
    contact: () => [
      ['out', 'telegram : @nxrskyaa'],
      ['out', 'email    : Nxrskyaa@gmail.com'],
    ...
    uptime: () => {
      const yrs = new Date().getFullYear() - 2013;
      return [['out', `up ${yrs} years — github account created march 2013, and never retired.`]];
    },
    neofetch: () => [
      ['ok', '        ⬡⬡⬡        guest@nxr-labs'],
      ['out', '      ⬡⬡⬡⬡⬡⬡      ───────────────'],
    ...
    'sudo hire-me': () => [
      ['err', 'permission denied: you\'re supposed to hire me, not the other way around.'],
      ['ok', '...but alright. DM telegram @nxrskyaa, let\'s talk 🤝']
    ],
    'sudo rm -rf /': () => [['err', 'nice try. 🛡️ this server is guarded 24/7.']]
  }
}
